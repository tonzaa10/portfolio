      ...
      >
        ...
        <div className="text-center z-10 px-4! flex flex-col gap-10 ">
          ...
          <p className="text-gray-400 text-lg mb-8 max-w-3xl! mx-auto!">
            Frontend Developer with experience in building responsive and SEO-friendly websites.
Skilled in HTML, CSS, JavaScript, and currently improving my React and Next.js development skills.
          </p>
